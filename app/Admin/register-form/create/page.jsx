...
/** Remove undefined values so Firestore addDoc doesn't throw */
...
export default function CreateRegisterFormPage() {
  ...
  async function saveForm() {
    ...
    try {
      ...
      alert(`Form saved successfully. Form ID: ${ref.id}`);
    ...
    <div className="min-h-screen bg-gray-100">
      <div className="sticky top-0 z-20 flex items-center justify-between gap-4 border-b border-gray-200 bg-white px-4 py-3 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-medium text-gray-700">Create Register Form</span>
        </div>
      ...
      <div className="mx-auto max-w-3xl px-4 py-8">
        <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
          <label className="mb-4 flex items-start gap-3 rounded-lg border border-indigo-100 bg-indigo-50/60 px-4 py-3">
            <input
              type="checkbox"
              checked={isFeedback}
            ...
            />
            <span>
              <span className="block text-sm font-medium text-gray-900">Feedback form</span>
            </span>
          </label>
          <input
            type="text"
